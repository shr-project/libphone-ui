...
void phoneui_info_unregister_audio_mode(void (*_cb)(void*, FreeSmartphoneAudioMode), void* data);
...
void phoneui_info_unregister_audio_device(void (*_cb)(void*, FreeSmartphoneAudioDevice), void* data);
...
void phoneui_info_unregister_audio_volume(void (*_cb)(void*, FreeSmartphoneAudioControl, int), void* data);
...
void phoneui_info_unregister_audio_mute(void (*_cb)(void*, FreeSmartphoneAudioControl, gboolean), void* data);
